...
class _ImageViewportState extends State<ImageViewport> {
  ...
  void initState() {
    ...
    _resolved = false;
    _centerOffset = widget.selectedQrOffset != null ? Offset(0, 0) : widget.selectedQrOffset ;
  ...
  void didUpdateWidget(ImageViewport oldWidget) {
    ...
    if(widget.selectedQrOffset != _centerOffset )
      _centerOffset = widget.selectedQrOffset;
              ...
              info = MapObject(
                child: DecoratedBox(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      SizedBox(width: 8,),
                      Text(object.title, style: TextStyle(
